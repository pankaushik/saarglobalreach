( function( $ ) {
    ...
    var pxl_swiper_handler = function( $scope, $ ) {
            ...
            carousel_settings = {
                ...
                on: {
                    ...
                    slideChange: function (swiper) { 
                        ...
                        var current = this.slides.eq(activeIndex);
                        setTimeout(function () {
                            var id_slide = '#' + $('.swiper-slide-active').attr('id');
                            $('.pxl-item-title').removeClass('active');
                            $('.pxl-item-title[data-target="' + id_slide + '"]').addClass('active');
                        }, 1);
                        $scope.find('.pxl-element-slider .pxl-swiper-slide .wow').each(function(){
                            $(this).removeClass('animated').addClass('pxl-invisible');
                        });
        ...
        carousel.each(function(index, element) {
            ...
            $('.pxl-item--titles .pxl-item-title').each(function(i){
    ...
    $( window ).on( 'elementor/frontend/init', function() {
        ...
        elementorFrontend.hooks.addAction( 'frontend/element_ready/pxl_template_carousel.default', pxl_swiper_handler );
    } );
} )( jQuery );